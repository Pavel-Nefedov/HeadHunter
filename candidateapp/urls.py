...
urlpatterns = [
    ...
    path('resume_create/', candidateapp.ResumeCreateView.as_view(), name='resume_create'),
    path('resume_delete/<int:pk>/', candidateapp.ResumeDeleteView.as_view(), name='resume_delete'),
